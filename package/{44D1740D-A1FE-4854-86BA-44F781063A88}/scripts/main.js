...
properties = {
	...
	showwallpaper: window.GetProperty("CUSTOM Show Wallpaper", true),
	wallpaperalpha: window.GetProperty("CUSTOM Wallpaper Alpha", 125),
	wallpaperblurred: window.GetProperty("CUSTOM Wallpaper Blurred", false),
	wallpaperblurvalue: window.GetProperty("CUSTOM Wallpaper Blur value", 1.05),
	wallpapermode: window.GetProperty("CUSTOM Wallpaper Type", -1),
	wallpaperpath: window.GetProperty("CUSTOM Default Wallpaper Path", my_utils.getDefaultWallpaperPath),
...
cTopBar = {
	...
	visible: window.GetProperty("SYSTEM.TopBar.Visible", false)
};
...
cHeaderBar = {
	...
	locked: window.GetProperty("SYSTEM.HeaderBar.Locked", false),
	timerAutoHide: false,
	sortRequested: false
};
